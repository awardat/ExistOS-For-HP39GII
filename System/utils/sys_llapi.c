...
DECDEF_LLSWI(void,         ll_charge_set_mode,    (bool liIon)                              ,LL_SWI_CHARGE_MODE               );
...
DECDEF_LLSWI(void,         ll_cpu_slowdown_enter,       (void)                                       ,LL_FAST_SWI_SLOWDOWN_ENTER          );
DECDEF_LLSWI(void,         ll_cpu_slowdown_exit,        (void)                                       ,LL_FAST_SWI_SLOWDOWN_EXIT           );
