...
//         INPUT_TRANSLATE(KEY_SYMB, KEY_CTRL_SETUP, KEY_CTRL_SETUP, KEY_CTRL_SETUP, KEY_CTRL_SETUP, KEY_CTRL_SETUP); // 2026-09-03 置空（SYMB/PLOT/NUM/APPS 释放）
        INPUT_TRANSLATE(KEY_VARS, KEY_CTRL_VARS, KEY_CTRL_INS, KEY_CTRL_INS, 'a', 'A');
        INPUT_TRANSLATE(KEY_MATH, KEY_CTRL_MENU, KEY_CTRL_CATALOG, KEY_CTRL_CATALOG, 'b', 'B');
        INPUT_TRANSLATE(KEY_ABC, KEY_CTRL_FRACCNVRT, KEY_CHAR_DQUATE, 0000000000000, 'c', 'C');
        INPUT_TRANSLATE(KEY_XTPHIN, KEY_CTRL_XTT, KEY_CHAR_EXPN10, KEY_CHAR_EXPN10, 'd', 'D');
        INPUT_TRANSLATE(KEY_BACKSPACE, KEY_CTRL_DEL, KEY_CTRL_AC, KEY_CTRL_AC, KEY_CTRL_DEL, KEY_CTRL_DEL);
        ...
        INPUT_TRANSLATE(KEY_SUBTRACTION, KEY_CHAR_MINUS, KEY_CHAR_ANGLE, KEY_CHAR_ANGLE, 'w', 'W');
...
//         INPUT_TRANSLATE(KEY_SYMB, KEY_CTRL_SYMB, KEY_CTRL_SETUP, KEY_CTRL_SETUP, KEY_CTRL_SETUP, KEY_CTRL_SETUP); // 2026-09-03 置空（SYMB/PLOT/NUM/APPS 释放）
//         INPUT_TRANSLATE(KEY_PLOT, KEY_CTRL_OK, KEY_CTRL_SETUP, KEY_CTRL_SETUP, KEY_CTRL_SETUP, KEY_CTRL_SETUP); // 2026-09-03 置空（SYMB/PLOT/NUM/APPS 释放）
        INPUT_TRANSLATE(KEY_VARS, KEY_CTRL_VARS, KEY_CTRL_INS, KEY_CTRL_INS, 'a', 'A');
