...
#else       /*LV_MEM_CUSTOM*/
    #define LV_MEM_CUSTOM_INCLUDE "portable.h"  //<stdlib.h>   /*Header for the dynamic memory function*/
...
#define LV_TICK_CUSTOM 0
    ...
    #define LV_TICK_CUSTOM_INCLUDE "sys_llapi.h"      
    #define LV_TICK_CUSTOM_SYS_TIME_EXPR (ll_get_time_ms()) 
...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(SourceHanSans11)

/*Always set a default font*/
//#define LV_FONT_DEFAULT &SourceHanSans11
