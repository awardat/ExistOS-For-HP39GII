...
void menu_setup()
{
  ...
  smallmenuitems[5].text = (char *)(giac::lang ? "\xb9\xd8\xd3\xda" : "About");
...
int Console_GetKey()
{
  ...
  for (;;)
  {
    ...
    if (key == KEY_CTRL_F6)
    {
      ...
      smallmenuitems[1].text = (char *)(giac::lang ? "\xc1\xed\xb4\xe6\xce\xaa" : "Save session as");
      smallmenuitems[2].text = (char *)(giac::lang ? "\xbc\xd3\xd4\xd8\xbb\xe1\xbb\xb0" : "Load session");
      smallmenuitems[3].text = (char *)(giac::lang ? "\xd0\xc2\xbd\xa8\xbb\xe1\xbb\xb0" : "New session");
      smallmenuitems[4].text = (char *)(giac::lang ? "\xd6\xb4\xd0\xd0\xbb\xe1\xbb\xb0" : "Run session");
      smallmenuitems[5].text = (char *)(giac::lang ? "\xbd\xc5\xb1\xbe\xb1\xe0\xbc\xad\xc6\xf7" : "Script editor");
      smallmenuitems[6].text = (char *)(giac::lang ? "\xb4\xf2\xbf\xaa\xbd\xc5\xb1\xbe" : "Open script");
      smallmenuitems[7].text = (char *)(giac::lang ? "\xd6\xb4\xd0\xd0\xbd\xc5\xb1\xbe" : "Run script");
      ...
      smallmenuitems[10].text = (char *)(giac::lang ? "\xb1\xe0\xbc\xad\xbe\xd8\xd5\xf3" : "Matrix editor");
      ...
      smallmenuitems[14].text = (char *)(giac::lang ? "\xb9\xd8\xd3\xda" : "About");
      // smallmenuitems[2].text = (char*)(isRecording ? "Stop Recording" : "Record Script");
      while (1)
      {
        int sres = doMenu(&smallmenu);
        if (sres == MENU_RETURN_SELECTION)
        {
          ...
          if (smallmenu.selection == 3)
          {
            ...
            {
              if (console_changed == 0 || strcmp(session_filename, "session") == 0 || giac::confirm(giac::lang ? "\xB5\xB1\xC7\xB0\xBB\xE1\xBB\xAD\xBD\xF8\xD0\xD0\xB6\xC8\xBF\xAA" : "Current session will be lost", giac::lang ? "F1: annul, F6: ok" : "F1: cancel, F6: ok") == KEY_CTRL_F6)
              {
