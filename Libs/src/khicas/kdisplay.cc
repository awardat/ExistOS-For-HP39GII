...
const char * completeCatZhName[] = { // 2026-09-16 命令目录中文名（显示层专用；name/insert/排序/搜索仍用英文原名，insert==NULL 的 159 条不受影响）
  ...
  "plotfunc(expr,[x,y])" " \xc1\xd0\xb1\xed\xbb\xe6\xcd\xbc",
  "plotlist(list)" " \xbd\xe2\xc7\xfa\xcf\xdf",
  "plotode(f(t,y),[t=tmin..tmax,y],[t0,y0])" " \xb2\xce\xca\xfd\xc7\xfa\xcf\xdf",
  "plotparam([x,y],t)" " \xbc\xab\xd7\xf8\xb1\xea\xcd\xbc",
  "plotpolar(r,theta)" " \xb5\xfc\xb4\xfa\xcd\xbc",
  "plotseq(f(x),x=[u0,m,M],n)" " \xb5\xe3\xd1\xf9\xca\xbd",
  "plus_point" " \xb5\xe3",
  "point(x,y[,z])" " \xb6\xe0\xb1\xdf\xd0\xce",
  "polygon(list)" " \xb5\xe3\xcf\xdf\xcd\xbc",
  "polygonscatterplot(Xlist,Ylist)" " \xb6\xe0\xc3\xe6\xcc\xe5",
  "polyhedron(A,B,C,D,...)" " \xb6\xe0\xcf\xee\xca\xbd\xbb\xd8\xb9\xe9",
  "polynomial_regression(Xlist,Ylist,n)" " \xb6\xe0\xcf\xee\xca\xbd\xbb\xd8\xb9\xe9\xcd\xbc",
  "polynomial_regression_plot(Xlist,Ylist,n)" " \xc3\xdd\xbb\xd8\xb9\xe9",
  "power_regression(Xlist,Ylist,n)" " \xc3\xdd\xbb\xd8\xb9\xe9\xcd\xbc",
  "power_regression_plot(Xlist,Ylist,n)" " \xc4\xa3\xc3\xdd",
  "powmod(a,n,p)" " \xb4\xf2\xd3\xa1",
  "print(expr)" " \xcd\xb6\xd3\xb0",
  "projection(obj1,obj2)" " \xb6\xe0\xcf\xee\xca\xbd\xc7\xf3\xb8\xf9",
  "proot(p)" " \xc7\xe5\xb3\xfd\xb1\xe4\xc1\xbf",
  "purge(x)" " \x50\x79\x74\x68\x6f\x6e\xd3\xef\xb7\xa8",
  "python(f)" " \x50\x79\x74\x68\x6f\x6e\xbc\xe6\xc8\xdd",
  "python_compat(0|1|2)" " \x51\x52\x20\xb7\xd6\xbd\xe2",
  "qr(A)" " \xb6\xfe\xb4\xce\xc7\xfa\xc3\xe6",
  "quadric(equation)" " \xb5\xda\xd2\xbb\xcb\xc4\xb7\xd6\xce\xbb",
  "quartile1(l)" " \xb5\xda\xc8\xfd\xcb\xc4\xb7\xd6\xce\xbb",
  "quartile3(l)" " \xd7\xdb\xba\xcf\xb3\xfd\xb7\xa8\xc9\xcc",
  "quo(p,q,x)" " \xb1\xa3\xb3\xd6\xb2\xbb\xc7\xf3\xd6\xb5",
  "quote(x)" " \xb0\xeb\xbe\xb6",
  "radius(objet)" " \xcb\xe6\xbb\xfa\xca\xfd",
  "rand()" " \xcb\xe6\xbb\xfa\xd5\xfb\xca\xfd",
  "randint(a,b)" " \xcb\xe6\xbb\xfa\xbe\xd8\xd5\xf3",
  "ranm(n,m,[loi,parametres])" " \xcb\xe6\xbb\xfa\xcf\xf2\xc1\xbf",
  "ranv(n,[loi,parametres])" " \xcd\xa8\xb7\xd6",
  "ratnormal(x)" " \xca\xb5\xb2\xbf",
  "re(z)" " \xb6\xc1\xce\xc4\xbc\xfe",
  "read(\"filename\")" " \xca\xb5\xd0\xc4\xbe\xd8\xd0\xce",
  "rectangle_plein a,b" " \xba\xf3\xcd\xcb",
  "recule n" " \xba\xec\xc9\xab",
  "red" " \xb7\xb4\xc9\xe4",
  "reflection(obj1,obj2)" " \xd7\xdb\xba\xcf\xb3\xfd\xb7\xa8\xd3\xe0",
  "rem(p,q,x)" " \xbc\xb6\xca\xfd\xb7\xb4\xd1\xdd",
  "revert(p[,x])" " \x52\x47\x42\x20\xd1\xd5\xc9\xab",
  "rgb(r,g,b)" " \xc1\xe2\xd0\xce\xb5\xe3",
  "rhombus_point" " \xd4\xb2",
  "rond n" " \xd0\xfd\xd7\xaa",
  "rotation(center,angle,objcet)" " \xb5\xdd\xcd\xc6\xbd\xe2",
  "rsolve(equation,u(n),[init])" " \xcc\xf8\xd4\xbe",
  "saute n" " \xc9\xa2\xb5\xe3\xcd\xbc",
  "scatterplot(Xlist,Ylist)" " \xd0\xf2\xc1\xd0\xc9\xfa\xb3\xc9",
  "segment(A,B)",
  "seq(expr,var,a,b)" " \xcf\xe0\xcb\xc6\xb1\xe4\xbb\xbb",
  "sign(x)",
  "similarity(center,ratio,angle,object)" " \xbb\xaf\xbc\xf2",
  "simplify(expr)",
  "single_inter(A,B)" " \xc7\xf3\xbd\xe2",
  "solve(equation,x)" " \xc5\xc5\xd0\xf2",
  "sorted(l)" " \xc7\xf2",
  "sphere(A,r)" " \xb7\xbd\xb5\xe3",
  "square_point" " \xd0\xc7\xb5\xe3",
  "star_point" " \xb1\xea\xd7\xbc\xb2\xee",
  "stddev(l)" " \xcc\xe6\xbb\xbb",
  "subst(a,b=c)" " \xc7\xf3\xba\xcd",
  "sum(f,k,m,M)" " \x53\x56\x44\x20\xb7\xd6\xbd\xe2",
  "svd(A)" " \xb1\xe4\xb2\xee\xb1\xed",
  "tabvar(f,[x=a..b])" " \xcc\xa9\xc0\xd5\xd5\xb9\xbf\xaa",
  "taylor(f,x=a,n,[polynom])" " \xb5\xda\xd2\xbb\xc0\xe0\xc7\xd0\xb1\xc8\xd1\xa9\xb7\xf2",
  "tchebyshev1(n)" " \xb5\xda\xb6\xfe\xc0\xe0\xc7\xd0\xb1\xc8\xd1\xa9\xb7\xf2",
  "tchebyshev2(n)" " \xc8\xfd\xbd\xc7\xba\xcf\xb2\xa2",
  "tcollect(expr)" " \xc8\xfd\xbd\xc7\xd5\xb9\xbf\xaa",
  "texpand(expr)" " \xbc\xc6\xca\xb1",
  "time(cmd)" " \xc8\xfd\xbd\xc7\xcf\xdf\xd0\xd4\xbb\xaf",
  "tlin(expr)" " \xd3\xd2\xd7\xaa",
  "tourne_droite n" " \xd7\xf3\xd7\xaa",
  "tourne_gauche n" " \xbc\xa3",
  "trace(A)" " \xd7\xaa\xd6\xc3",
  "transpose(A)" " \xc6\xbd\xd2\xc6",
  "translation(vect,obj)" " \xc8\xfd\xbd\xc7\xd0\xce",
  "triangle(A,B,C)" " \xc8\xfd\xbd\xc7\xd0\xce\xb5\xe3",
  "triangle_point" " \xc8\xfd\xbd\xc7\xd7\xaa\xd6\xb8\xca\xfd",
  "trig2exp(expr)" " \xd7\xaa\xce\xaa\xd3\xe0\xcf\xd2",
  "trigcos(expr)" " \xd7\xaa\xce\xaa\xd5\xfd\xcf\xd2",
  "trigsin(expr)" " \xd7\xaa\xce\xaa\xd5\xfd\xc7\xd0",
  "trigtan(expr)" " \xbe\xf9\xd4\xc8\xb7\xd6\xb2\xbc",
  "uniformd(a,b,x)" " \xb6\xa5\xb5\xe3",
  "vertices(objet)" " \xd0\xb4\xce\xc4\xbc\xfe",
  "write(\"filename\",var)" " \xbb\xc6\xc9\xab",
  "yellow",
